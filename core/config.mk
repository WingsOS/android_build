...
ifneq ($(WINGS_BUILD),)
include vendor/wings/config/BoardConfigWings.mk
endif
...
ifneq ($(WINGS_BUILD),)
ifneq ($(wildcard device/wings/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/wings/sepolicy/common/sepolicy.mk)
endif
endif
